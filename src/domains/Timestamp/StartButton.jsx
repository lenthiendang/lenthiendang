...
const StyledButton = styled.div`
  ...
  .sun {
    ...
    box-shadow: ${(props) => (props.top ? '0px 0px 72px 1rem' : '0px 0px 36px')} #ffdc2a;
    z-index: 2;
    border-radius: 65px;
    transition: all 1s ease-in-out;
  }
  .button {
    ...
    background: ${(props) => `${theme.colors[props.color][500]}${theme.opacity[800]}`};
...
const StartButton = ({ title, color }) => {
  ...
  return (
    <StyledButton top={top} color={color}>
